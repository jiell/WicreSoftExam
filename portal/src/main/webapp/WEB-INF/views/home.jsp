							...
							<div class="flex-caption">
								...
								<div class="col-l">
									<p style="text-indent:2em;">
										WicreSoftExam是国内首款一款基于JAVA与MYSQL开发的网络考试系统。它可以稳定、顺畅的运行在Windows与Linux平台上。您可以通过它快捷方便的创建试题和题库，发布试卷，组织考试，系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。
									</p>
									<p style="text-indent:2em;">
							...
							<c:choose>
								<c:when test="${fn:length(newsList) eq 1 }">
									<li class="news-list-item clearfix">
										...
										<div class="news-list-thumbnail">
											<img src="resources/images/index3.jpg">
										</div>
								...
								<c:otherwise>
									...
									<li class="news-list-item clearfix">
										...
										<div class="news-list-thumbnail">
											<img src="http://www.wicresoft.com/resources/images/index/index2.jpg">
										</div>
										<div class="news-list-content">
											<div class="news-list-title">
												${newsList[1].title }
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="copy">
							<p>
								WicreSoftExam Copyright © <a href="http://www.wicresoft.com/" target="_blank">WicreSoftExam</a> - <a href="." target="_blank">主页</a> | <a href="http://www.wicresoft.com/" target="_blank">关于我们</a> | <a href="http://www.wicresoft.com/" target="_blank">FAQ</a> | <a href="http://www.wicresoft.com/" target="_blank">联系我们</a>
							</p>
						</div>
					</div>
				</div>
